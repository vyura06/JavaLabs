...
public class Main {
    ...
    public static final String LAST_NAME_OF_THE_WORKER = "Enter the last name of the worker:";
    public static final String NAME_OF_THE_WORKSHOP = "Enter the name of the workshop:";
    ...
    public static void fillTeachers(Teacher teacher) {
        ...
        System.out.println(LAST_NAME_OF_THE_WORKER);
        enterTeacherSurname(teacher);
        System.out.println(NAME_OF_THE_WORKSHOP);
        enterDay(teacher);
    }
    ...
    /*public static void deleteByRecordsInFile() {
        String pathname;
        File file_input;
        boolean isNotCorrect = true;
        do {
    ...
    /*public static void readFileRemove(File file) {
        String line;
        try (Scanner scanner = new Scanner(new FileInputStream(file))) {
            while (scanner.hasNextLine()) {
                line = scanner.nextLine();
                if (!line.equals("")) {
                    removeRecordLikeInFile(line);
                }
            }
        } catch (IOException exp) {
            System.out.println(exp.getMessage());
    ...
    public static void removeRecordLikeInFile(String line) {
        String[] arr = line.split("\\s");
        if (arr.length == 5) {
            for (int i = 0; i < teachers.size(); i++) {
                if (teachers.get(i).last_name.equals(arr[0]) && teachers.get(i).workshop_name.equals(arr[1])) {
    ...
    public static int searchIndexBySurName() {
        ...
        boolean isNotCorrect = true;
        do {
            System.out.println("Enter the last name for which you want to search the record:");
            surname = in.nextLine();
            for (int i = 0; i < teachers.size(); i++) {
