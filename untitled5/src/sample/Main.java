...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Pane root = new Pane();
        Image image = new Image(getClass().getResourceAsStream("_1284-4743.jpg"));
        ...
        SubMenu optionsMenu = new SubMenu(keys,optionsBack);
        MenuItem NG1 = new MenuItem("ЗАПУСТИТЬ");
        MenuItem NG2 = new MenuItem("НАЗАД");
        ...
        NG2.setOnMouseClicked(event-> menuBox.setSubMenu(mainMenu));
    ...
    private static class MenuItem extends StackPane{
        public  MenuItem(String name){
            Rectangle bg = new Rectangle(200,50,Color.WHITE);
            bg.setOpacity(0.5);
    ...
    private static class MenuBox extends Pane{
        ...
        public MenuBox(SubMenu subMenu){
            ...
            setVisible(false);
            Rectangle bg = new Rectangle(450,600,Color.LIGHTBLUE);
            bg.setOpacity(0.4);
